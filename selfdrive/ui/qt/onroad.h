...
protected:
  ...
  void drawLockon(QPainter &painter, const cereal::ModelDataV2::LeadDataV3::Reader &lead_data, const QPointF &vd , int num , size_t leads_num , cereal::ModelDataV2::LeadDataV3::Reader &lead0 , cereal::ModelDataV2::LeadDataV3::Reader &lead1);
